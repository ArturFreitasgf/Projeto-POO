...
Eliel : Sistema de Eventos 

Kelvson : Sistema de Restaurante 

Artur/Kelvson : Sistema de Clínica 
...
Agendar Consulta: Permite que os funcionários agendem consultas para pacientes, facilitando o controle do calendário de atendimentos. 
...
Buscar Paciente: Facilita a busca e visualização de dados de pacientes, permitindo um gerenciamento mais eficiente do histórico médico e agendamentos. 
